...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '荩尧', // 您的昵称 例如 tangly1024
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/kiroZhang1997', // 你的github个人主页 例如 https://github.com/tangly1024
